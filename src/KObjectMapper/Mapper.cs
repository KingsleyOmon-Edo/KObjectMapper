...
public class Mapper : IObjectMapper
{
    ...
    /// <summary>
    /// Maps properties from source to target using graph mapping options for circular reference and depth tracking.
    /// </summary>
    ...
    public void Map(object source, object target, GraphMappingOptions options)
    {
        ...
        _mappingService.ApplyDiffs(source, target, visited, depth: 0, maxDepth: options.MaxDepth);
    }
